...
CREATE TABLE transfer(
	...
	CONSTRAINT FK_transfer_status FOREIGN KEY (transfer_status) REFERENCES status (status_name),
	CONSTRAINT FK_transfer_type FOREIGN KEY (transfer_type) REFERENCES transfer_type (type_name)
);
